...
wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/JerrySBG/SBG2/main/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/JerrySBG/SBG2/main/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/JerrySBG/SBG2/main/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/JerrySBG/SBG2/main/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
...
echo -e "$COLOR1│  [ 4 ]  \033[1;37mCAMBIAR NOMBRE DEL BOT (MULTI SERVER)     ${NC}"
...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
echo -e ""
read -e -p "[*] Ingrese su apodo de BOT: " namabot
...
clear
echo -e "Éxito al cambiar el apodo del BOT Telegram"
echo -e "Si desea llamar al menú del BOT, toque .${namabot} o /${namabot}"
echo -e "Si quieres llamar Inicia el BOT Toca .start${namabot} o /start${namabot}"
systemctl restart kyt
read -n 1 -s -r -p "Press any key to back on menu"
menu
fi
...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
echo -e ""
read -e -p "[*] Ingrese la ID de usuario : " user
