...
echo "IP=$host" > /var/lib/phantomshield-pro/ipvps.conf
echo ""
...
sleep 2
wget -q -O /root/sbg.sh "https://raw.githubusercontent.com/JerrySBG/SBG2/main/sbg.sh" && chmod +x /root/sbg.sh
sleep 2
./sbg.sh
sleep 5
rm /root/sbg
rm /opt/.ver
version_up=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/versi)
echo "$version_up" > /opt/.ver
echo -e "$COLOR1│${NC}  $COLOR1[INFO]${NC} Successfully Up To Date!"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • JERRY •                $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo ""
read -n 1 -s -r -p "  Press any key to back on menu"
menu
