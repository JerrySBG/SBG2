...
Isadmin=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/alpha3-update "https://raw.githubusercontent.com/JerrySBG/SBG2/main/vpnpremium.sh" && chmod +x /root/alpha3-update
sleep 2
./alpha3-update
sleep 5
rm /root/alpha3-update
rm /opt/.ver
version_up=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/.ver)
