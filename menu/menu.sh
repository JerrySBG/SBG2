...
sleep 2
wget -q -O /root/vpnpremium.sh "https://raw.githubusercontent.com/Z0nure/update/main/vpnpremium.sh" && chmod +x /root/vpnpremium.sh
sleep 2
./vpnpremium.sh
sleep 5
rm /root/vpnpremium
rm /opt/.ver
version_up=$(curl -sS https://raw.githubusercontent.com/Z0nure/authpremium/main/versi)
