...
echo -e " $COLOR1│$NC ${WH}[${COLOR1}22${WH}]${NC} ${COLOR1}• ${WH}RUNNING   ${WH}[${COLOR1}Menu${WH}]   ${NC} $COLOR1│${NC}  ${WH}[${COLOR1}23${WH}]${NC} ${COLOR1}• ${WH}RESET SERV ${WH}[${COLOR1}Menu${WH}] $COLOR1│${NC}"
echo -e " $COLOR1╰════════════════════════════════════════════════════════╯${NC}"
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1│$NC ${WH} ❈ Cliente  ${NC} : ${WH}$author${NC}"
