...
echo -e "♣${BIYellow} Cantidad Ram        👉 ${BICyan}${totalram} MB"
echo -e "♣${BIYellow} CPU Usage           👉 ${BICyan}$cpu_usage"
echo -e "♣${BIYellow} Time Reboot VPS     👉 ${BICyan}00:00 ${BICyan}(las 12 de la noche)${NC}"
echo -e "♣${BIYellow} Whatsapp            👉 ${BICyan}+529241293310${NC}"
echo -e "♣${BIYellow} AutoScript By       👉 ${BICyan}Jerry SBG${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan}  $NC ${BICyan}Hoy${NC}: ${BIYellow}$ttoday$NC ${BICyan}AYER${NC}: ${BIYellow}$tyest$NC ${BICyan}Mes${NC}: ${BIYellow}$tmon$NC $NC"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌─────────────────────────────────────┐${NC}"
...
0) clear ; menu ;;
x) exit ;;
*) echo "Lo presionaste mal " ; sleep 1 ; ctrl+c ;;
esac
