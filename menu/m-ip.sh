...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/SBG2/main/ipvps | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/SBG2.git &> /dev/null
cd /root/v5/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch vps &> /dev/null
...
git remote add origin https://github.com/${USERGIT}/SBG2.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/SBG2.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/SBG2.git
cd /root/v5/
rm -rf .git
git init
touch vps
...
git commit -m renew
git branch -M main
git remote add origin https://github.com/${USERGIT}/SBG2.git
git push -f https://${APIGIT}@github.com/${USERGIT}/SBG2.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• RENEW EXP IPVPS •             ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1 ${NC} [INFO] PM : https://wa.me/+529241293310"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── ${WH}BY${NC} ${COLOR1}───────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                ${WH}•  •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
