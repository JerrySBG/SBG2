...
clear
sleep 1
echo -e "${COLOR1}[ INFO ] ${WH}Iniciando... "
mkdir -p /root/backup
echo -e "${COLOR1}[ INFO ] ${WH}Espere Por Favor... "
wget -O /root/backup/ipmini https://raw.githubusercontent.com/JerrySBG/permission/main/ip &> /dev/null
