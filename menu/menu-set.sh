...
echo -e "     ${BICyan}[${BIWhite}03${BICyan}] Chek Running System   "
...
echo -e "     ${BICyan}[${BIWhite}09${BICyan}] Chek Usage Bandwith"
echo -e "     ${BICyan}[${BIWhite}10${BICyan}] Backup & Restore"
echo -e "     ${BICyan}[${BIWhite}11${BICyan}] Bot Telegram"
echo -e "     ${BICyan}[${BIWhite}12${BICyan}] Nuevo registro de IP (${BIRed}Solo para administrador${BICyan})${NC}"
echo -e "     ${BICyan}[${BIWhite}13${BICyan}] Webmin Menu      "
echo -e "     ${BICyan}[${BIWhite}14${BICyan}] Configuración del Reinicio Automático"
...
9) clear ; bw ; exit ;;
10) clear ; menu-bckp ; exit ;;
11) clear ; m-bot ; exit ;;
12) clear ; m-ip ; exit ;;
13) clear ; menu-webmin ; exit ;;
14) clear ; jam ; exit ;;
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "Lo presionaste mal, cariño" ; sleep 1 ; menu ;;
esac
