...
echo -e "$green██║██║░╚███║██████╔╝░░░██║░░░██║░░██║███████╗███████╗  ██████╔╝██████╔╝██║░░██║$NC"
echo -e "$green╚═╝╚═╝░░╚══╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚══════╝  ╚═════╝░╚═════╝░╚═╝░░╚═╝$NC"
echo -e "$green GRACIAS POR USAR mi SCRIPT By JerrySBG$NC"
sleep 2
...
echo -e "$green━━━━━━━━━━━━━━━━━━━━━┗┛━━━━━━━━━━━━━━━━━━━━━━┗━━┛$NC"
    ...
    echo -e "$BYellow----------------------------------------------------------$NC"
    echo -e "$BGreen 1. Use Domain Random / Ingresa Un Dominio Ramdon del Script $NC"
    echo -e "$BGreen 2. Choose Your Own Domain / Ingresa Dominio Propio $NC"
    echo -e "$BYellow----------------------------------------------------------$NC"
...
izinsc="https://raw.githubusercontent.com/JerrySBG/SBG2/main/izin"
rm -f /usr/bin/user
...
TEXT="Instalacion AutoScript v1.0 By JERRY
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
sleep 2
clear
wget -q -O slow.sh https://raw.githubusercontent.com/JerrySBG/SBG2/main/slow.sh && chmod +x slow.sh && ./slow.sh
clear
cat> /root/.profile << END
if [ "$BASH" ]; then
if [ -f ~/.bashrc ]; then
...
echo -e "
"
read -n 1 -s -r -p "Presione cualquier tecla para acceder al menú"
menu
