...
sleep 1
echo -e "[ ${tyblue}NOTES${NC} ] I Primero debes revisar tus encabezados..."
sleep 2
echo -e "[ ${green}INFO${NC} ] Comprobando encabezados"
sleep 1
...
sleep 2
echo -ne "[ ${green}INFO${NC} ] Comprobar Permiso : "
...
clear
yellow "Agregar Dominio para Vmess/Vless/Trojan "
echo " "
echo -e "$green      Por favor Seleccione un Tipo de Dominio a Continuación               $NC"
echo  ""
tyblue "    1 : Ingrese su Subdominio"
tyblue "    2 : Utilice un Subdominio Aleatorio"
echo ""
read -p "   Seleccione los números 1-2 o cualquier botón (aleatorio) : " host
echo ""
if [[ $host == "1" ]]; then
read -rp "Introduce tu Dominio : " -e pp
echo "$pp" > /root/domain
...
#install cf
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/ssh/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
echo -e "Se utiliza Subdominio/Dominio Aleatorio"
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/ssh/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
fi
...
sleep 2
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/wireguard/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
sleep 2
#install ssh ohp
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/OPENVPN/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
wget -q https://raw.githubusercontent.com/JerrySBG/SBG2/main/ssh/notif.sh;chmod +x notif.sh;./notif.sh
sleep 3
clear
#install limit xray
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget -q https://raw.githubusercontent.com/JerrySBG/SBG2/main/ssh/limit.sh;chmod +x limit.sh;./limit.sh
sleep 1
wget -q https://raw.githubusercontent.com/JerrySBG/SBG2/main/ssh/bosqu93;chmod +x bosqu93;./bosqu93
rm bosqu93
clear
