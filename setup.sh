...
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
...
<font color="red"><b>********  JERRY SBG  ********</b></font><br>
...
echo " "
clear
echo -e "La instalación fue exitosa y sin problemas" 
echo -e "" 
echo -e "     <= Debes leerlo y hacerlo. =>" 
echo -e "El puerto de inicio de sesión de VPS de 22 cambió a 3303" 
echo -e "porque si inicias sesión en vps usas el puerto 22, es fácil usar fuerza bruta" 
echo -e "" 
echo -e "Para abrir el panel de entrada de AutoSC" 
echo -e "orden (funny) sin paréntesis" 
echo -e "" 
