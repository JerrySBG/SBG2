...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
curl -o /usr/bin/wlc https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/wlc

# Fetch the raw content of the 'info' file and save it to /usr/bin as info
curl -o /etc/update-motd.d/69-wlc https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/info2
...
rm insshws.sh
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/sshws/nontls.sh && chmod +x nontls.sh && ./nontls.sh
rm nontls.sh
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/sshws/nontls2.sh && chmod +x nontls2.sh && ./nontls2.sh
rm nontls2.sh
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/sshws/nontls3.sh && chmod +x nontls3.sh && ./nontls3.sh
rm nontls3.sh
clear
sleep 0.5
#
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/ipsec/ipsec.sh && chmod +x ipsec.sh && ./ipsec.sh
rm ipsec.sh
clear
#
#install ssh SSTP
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/sstp.sh && chmod +x sstp.sh && ./sstp.sh
rm sstp.sh
clear
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/wireguard/wg.sh && chmod +x wg.sh && ./wg.sh
rm wg.sh
clear
#Instal UDP & Slow Dns
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
rm udp.sh
clear
#Instal UDP & Slow Dns
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/update/updatemenu.sh && chmod +x updatemenu.sh && ./updatemenu.sh
rm updatemenu.sh
clear
cd /usr/bin/
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/vpnpremium.sh && chmod +x vpnpremium.sh && ./vpnpremium.sh
sleep 2
chmod +x vpnpremium
sleep 2
cd
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/.ver )
