...
cd /root
zip -r $IP-$date-$domain-SBG2.zip backup > /dev/null 2>&1
rclone copy /root/$IP-$date-$domain-SBG2.zip dr:backup/
url=$(rclone link dr:backup/$IP-$date-$domain-SBG2.zip)
id=(`echo $url | grep '^https' | cut -d'=' -f2`)
link="https://drive.google.com/u/4/uc?id=${id}&export=download"
clear
echo -e "\033[1;37mVPS Data Backup By JERRY\033[0m
\033[1;37mTelegram : https://t.me/Jerry_SBG / @Jerry_SBG\033[0m"
echo ""
...
rm -rf /root/backup
rm -r /root/$IP-$date-$domain-SBG2.zip
echo ""
