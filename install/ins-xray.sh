...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/JerrySBG/SBG2/main/acme.sh -o /root/.acme.sh/acme.sh
...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/jerry-vlesswstls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/jerry-vmesswstls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/jerry-trojanwstls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/jerry-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/jerry-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/jerry-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/SBG2/main/cert.sh"
