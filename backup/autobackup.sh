...
echo " Data Will Be Backed Up Automatically at 00:05 UTC -6"
exit 0
}
function stop() {
email=$(cat /home/email)
...
email=$(cat /home/email)
echo -e "
This is the content of the test email sent from the VPS.
IP VPS : $IP
Date : $date
" | mail -s "Sending Trial Email" $email
}
clear
echo -e "=============================="
...
echo -e "3. Change EMAIL recipient"
echo -e "4. Change Email Sender"
