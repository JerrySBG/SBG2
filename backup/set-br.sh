...
wget -q -O /root/.config/rclone/rclone.conf "https://https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://https://raw.githubusercontent.com/JerrySBG/SBG2/main/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
