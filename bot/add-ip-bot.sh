#!/bin/bash
# // PROJECT XDXL STORE
url_izin="https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip"
...
git clone https://github.com/JerrySBG/SBG2.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
git remote add origin https://github.com/JerrySBG/SBG2
git push -f https://${TOKEN}@github.com/JerrySBG/SBG2.git &> /dev/null
rm -rf /root/ipvps
clear
