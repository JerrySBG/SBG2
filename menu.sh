...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# Order ID
rm -f /usr/bin/ver
user=$(curl https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | grep $MYIP | awk '{print $3}')
...
echo -e "  \e[$below Autoscript By        : JERRY"
echo -e "  \e[$below Certificate Status   : Expira En $certifacate dias"
