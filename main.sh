...
secs_to_human() {
    echo "Tiempo de Instalacion: $(( ${1} / 3600 )) Hora $(( (${1} / 60) % 60 )) Minutos $(( ${1} % 60 )) Segundos"
}
start=$(date +%s)
...
yellow " Nota : ANTES DE INGRESAR UN DOMINIO"
yellow " POR FAVOR PRIMERO APUNTE EL DOMINIO A SU IP VPS !"
echo -e "${red}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
    echo -e "${red}    ♦️${NC} ${green} CONFIGURACION DOMINIO VPS     ${NC}"
    echo -e "${red}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
read -rp "Ingrese su dominio : " -e pp
    if [ -z $pp ]; then
        echo -e "
        ¡Nada de entrada para el dominio!
...
rm -rf set-br.sh
clear
echo -e "[ ${green}INFO${NC} ] Instalando Servicio Xray..."
sleep 2
wget -q ${REPO}ssh/ins-xray && chmod +x ins-xray && ./ins-xray
rm -rf ins-xray
echo -e "[ ${green}INFO${NC} ] Instalando Servicio SlowDNS..."
sleep 2
wget -q ${REPO}slowdns/nameserver && chmod +x nameserver && ./nameserver
rm -rf nameserver
clear
echo -e "[ ${green}INFO${NC} ] Instalando Servicio Udp Custom..."
sleep 2
...
rm -rf menu
clear
echo -e "[ ${green}INFO${NC} ] Instalando Servicio Websocket..."
sleep 2
...
clear
echo -e "[ ${green}INFO${NC} ] Instalando Servicio Vnstat..."
sleep 2
### SERVICE VNSTAT ###
...
echo "   - UDP          : 1-65556" | tee -a log-install.txt
echo "   - SSH Websocket	: 80, 8080, 2082" | tee -a log-install.txt
echo "   - SSH SSL Websocket	: 443, 444" | tee -a log-install.txt
echo "   - Stunnel4		: 443, 444" | tee -a log-install.txt
echo "   - Dropbear		: 109, 143" | tee -a log-install.txt
echo "   - Badvpn		: 7100-7300" | tee -a log-install.txt
echo "   - Nginx		: 81" | tee -a log-install.txt
echo "   - Vmess TLS		: 443, 444" | tee -a log-install.txt
echo "   - Vmess None TLS	: 80, 8080, 8280" | tee -a log-install.txt
echo "   - Vless TLS		: 443, 444" | tee -a log-install.txt
echo "   - Vless None TLS	: 80, 8080, 8280" | tee -a log-install.txt
echo "   - Trojan GRPC		: 443, 444" | tee -a log-install.txt
echo "   - Trojan WS		: 443, 444" | tee -a log-install.txt
echo "   - Trojan Go		: 443, 444" | tee -a log-install.txt
echo "   - SlowDNS          : 443, 5300, 53" | tee -a log-install.txt
...
echo -e ""
read -p "Presiona [ Enter ] Para Reiniciar VPS"
reboot
