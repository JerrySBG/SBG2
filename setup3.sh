...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By JERRY"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @Jerry_SBG"$NC
echo -e "$green.........................................................."$NC
echo ''
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You are Allowed to use AUTOSCRIPT JERRY..\e[0m"
        sleep 5
    else
...
IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/SBG2/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/ssh-vpn2.sh && chmod +x ssh-vpn2.sh && screen -S ssh-vpn ./ssh-vpn2.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/ins-xray2.sh && chmod +x ins-xray2.sh && screen -S ins-xray ./ins-xray2.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/SBG2/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
# Version
ver=$( curl https://raw.githubusercontent.com/${GitUser}/SBG2/main/version )
history -c
echo "$ver" > /home/ver
clear
echo " "
...
echo "   - Websocket SSH(HTTP)     : 80, 8001, 8080, 8280"  | tee -a log-install.txt
...
echo "   - Timezone                : America/Mexico_City (UTC -6)"  | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════ Autoscript By JERRY ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY JERRY          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
