...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/JerrySBG/SBG2/main/auth | awk '{print $4}' | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/JerrySBG/SBG2/main/sstp/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
