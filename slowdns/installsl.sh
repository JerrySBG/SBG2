...
clear  
echo -e "$BIBlue╭═══════════════════════════════════════════╮${NC}"
echo -e "$BIBlue│$NC         \e[1;32mConfigurar Dominio SlowDNS        $BIBlue│${NC}"  
echo -e "$BIBlue╰═══════════════════════════════════════════╯${NC}"
echo -e "$BIBlue╭═══════════════════════════════════════════╮${NC}" 
echo -e "$BIBlue│  [ 1 ]  \e[1;32mPropio Dominio SlowDNS                ${NC}"  
echo -e "$BIBlue│  [ 2 ]  \e[1;32mDominio Aletorio Free                 ${NC}" 
echo -e "$BIBlue│  [ 3 ]  \e[1;32mDominio Aletorio By JERRY-SBG             ${NC}"                                
echo -e "$BIBlue╰═══════════════════════════════════════════╯${NC}"
until [[ $slow =~ ^[1-3]+$ ]]; do 
...
clear
echo -e "$BIBlue╭═══════════════════════════════════════════╮${NC}"
echo -e "$BIBlue│$NC               \e[1;32mDOMINIO SLOWDNS             $BIBlue│${NC}"  
echo -e "$BIBlue╰═══════════════════════════════════════════╯${NC}"
echo -e "$BIBlue╭═══════════════════════════════════════════╮${NC}"
echo -e "$BIBlue│$NC  \e[1;32mDebes de tener Ya Configurado tu Dominio $BIBlue│${NC}"  
echo -e "$BIBlue╰═══════════════════════════════════════════╯${NC}"
