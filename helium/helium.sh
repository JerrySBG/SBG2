...
function install() {
	...
	wget -q -O /etc/dnsmasq.conf "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/dnsmasq.conf"
	sed -i "s/YourPublicIP/${publicIP}/" /etc/dnsmasq.conf
	rm -rf ${providers}
	wget -q -O ${providers} "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/providers.txt"
	rm -rf /usr/local/sbin/helium_daily
	wget -q -O /usr/local/sbin/helium_daily "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/helium_daily.sh"
...
function cleaner() {
	...
	#wget -q -O /etc/dnsmasq/dead.hosts "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/dead.hosts"
...
function updateHelium() {
	...
	wget -q -O /tmp/helium.tmp "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/helium.sh"
	...
	if [[ ${OVERWRITE,,} == "y" ]]; then
		...
		wget -q -O /etc/dnsmasq/providers.txt "https://raw.githubusercontent.com/JerrySBG/SBG2/main/helium/providers.txt"
	fi
