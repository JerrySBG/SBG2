...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/Z0nure/PhantomShield/main/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
