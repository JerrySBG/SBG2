...
clear
echo -e  "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e  "${tyblue}│            INTRODUZCA SU NOMBRE          │${NC}"
echo -e  "${tyblue}└──────────────────────────────────────────┘${NC}"
echo " "
...
clear
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}│ ${BGCOLOR} Por Favor Seleccione su Opción         ${tyblue} │${NC}"
echo -e "${tyblue}╰══════════════════════════════════════════╯${NC}"
echo -e "${tyblue}╭══════════════════════════════════════════╮${NC}"
echo -e "${tyblue}│  [ 1 ]  \033[1;37mPRUEBA DE 1 DÍA      ${NC}"
echo -e "${tyblue}│  [ 2 ]  \033[1;37mUSUARIO YA COMPRADO     ${NC}"
echo -e "${tyblue}╰══════════════════════════════════════════╯${NC}"
until [[ $key =~ ^[12]+$ ]]; do 
...
clear
echo -e  "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e  "${tyblue}│    INTRODUZCA LA CLAVE DE LA LICENCIA    │${NC}"
echo -e  "${tyblue}└──────────────────────────────────────────┘${NC}"
echo " "
...
LIST=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip | grep $kode | awk '{print $6}')
cd
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/JerrySBG/SBG2/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
