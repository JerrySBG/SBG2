...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/JerrySBG/SBG2/main/acs-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/JerrySBG/SBG2/main/xray/certv2ray.sh" && chmod +x /usr/bin/crtxray 
sleep 1
