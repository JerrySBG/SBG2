...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}=========================================================${NC}"
echo -e " ${REDBG} Bienvenido al Auto-Script MOD´s EDICION${NC}"
echo -e " ${YELLOW} Esto Configurará Rápidamente el SCRIPT VPN en su Servidor${NC}"
echo -e "${purple}=========================================================${NC}"
echo -e " ${YELLOW} Autor : ${RED}JERRY® ${NC}( ${YELLOW} Whatsapp: 529241293310 ${NC})${NC}"
echo -e " ${RED} © DEV JERRY-SBG ${NC}${YELLOW}(${NC}${green}V 1.0${NC}${YELLOW})${NC}"
echo -e " ( ${YELLOW} Hecho en Mexico ${NC}) ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}=========================================================${NC}"
echo ""
sleep 2
...
echo -e "   '=================================================='"
echo -e "     \e[1;32m1)\e[0m ♦️ Dominio Propio (Recomendado)"
echo -e "     \e[1;32m2)\e[0m ♦️ Utilice un Dominio Aleatorio Personalizado (Digital Ocean) "
echo -e "   ===================================================="
...
clear
izinsc="https://raw.githubusercontent.com/JerrySBG/SBG2/main/ip"
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/JerrySBG/SBG2/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/JerrySBG/SBG2/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
wget -q https://raw.githubusercontent.com/JerrySBG/SBG2/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
print_success "Servicio Limite IP Instalado"
}
...
clear
print_install "Instalación Dropbea"
# // Installing Dropbear
...
function ins_udpSSH(){
clear
print_install "Instalación Udp-custom"
...
function ins_swab(){
clear
print_install "Instalación Swap 1 G"
...
print_success "Swap 1 G Instalado"
}
...
print_success "NOOBZVPN By JERRY®"
}
...
function menu(){
    clear
    print_install "Instalación Paquete de Menu"
...
print_success "Paquete de Menu Instalado"
}
...
echo -e "\e[96;1m          -[ AUTOSCRIPT VPN PREMIUM ]-                 \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
...
echo -e "\033[0;32m└─────────────────────────────────────────────┘"
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[92;1m               [ By JERRY® ]                      \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e "t.me/Jerry_SBG"
echo -e " GRACIAS POR UTILIZAR LOS SERVICIOS PREMIUM DEL SCRIPT VPN"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo ""
read -p "[ Enter ]  Para REINICIAR VPS"
reboot