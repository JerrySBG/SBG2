...
tmp3=$(echo -n "aes-256-cfb:${SSTrial}@${domain}:$tls" | base64 -w0)
tmp4=$(echo -n "aes-256-cfb:${SSTrial}@${domain}:$http" | base64 -w0)
linkss3="ss://${tmp3}?plugin=obfs-local;obfs=tls;obfs-host=google.com"
...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "Link OBFS TLS : $linkss3"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "Link OBFS HTTP : $linkss4"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
read -n 1 -s -r -p "Presione cualquier tecla para volver al MENU"            
ss-menu
