...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • JerrySBG •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
read -n 1 -s -r -p "   Press any key to back on menu"
menu-ip
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/acces/main/punten | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/acces.git &> /dev/null
cd /root/acces/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch punten &> /dev/null
...
Reg Date    : $hariini
" 
echo "${TEXT}" >>/root/acces/newuser 
echo "### $client $exp $daftar $isadmin" >>/root/acces/ip 
git add .
git commit -m register &> /dev/null
git branch -M main &> /dev/null
git remote add origin https://github.com/${USERGIT}/acces.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/acces.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
name1=$(grep -E "^### " "/root/acces/punten" | cut -d ' ' -f 2 | sed -n "$nombor"p) #name
exp=$(grep -E "^### " "/root/acces/punten" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " "/root/acces/punten" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
...
" 
echo "${TEXTD}" >>/root/acces/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/acces.git
cd /root/acces/
rm -rf .git
git init
touch punten
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/acces/punten")
...
git push -f https://${APIGIT}@github.com/${USERGIT}/acces.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/JerrySBG/SBG2/main/izin | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
