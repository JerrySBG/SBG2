...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/JerrySBG/SBG2/main/ipvps | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
echo -e "${NC}${LIGHT}WhatsApp : 9241294410"
echo -e "${NC}${LIGHT}Telegram : https://t.me/Jerry_SBG"
exit 0
fi
# ==================================================
# Link Hosting Kalian
bosqu="raw.githubusercontent.com/JerrySBG/SBG2/main/wireguard"
